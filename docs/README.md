# Kachi Button Development and Specifications

Updated September 12, 2026. These English specifications consolidate the preliminary concepts, the design discussion, PCB v1 exports, and the latest product reference.
...
| [Keyboard development](firmware-development.md) | Build, configure, enter upload mode, flash, validate, and troubleshoot |
| [Keyboard features](firmware-features.md) | Implemented behavior, LED patterns, limits, and verification status |
| [Keyboard internals](firmware-internals.md) | Source map, USB transactions, storage format, and change boundaries |
...
| Configuration | Implemented: USB CLI text/count/ms-interval editing and DataFlash save; browser/vendor HID remains planned |
...
| Firmware | CH55xduino 0.0.26 selected; host-only upload and persistence verified; measure physical repeat timing, LED waveform, and power behavior |
...
| Prototype | Initial USB/HID bring-up and fixed-text input verified; enclosure fit and broader electrical validation remain pending |
